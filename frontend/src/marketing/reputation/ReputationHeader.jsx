...
export default function ReputationHeader({
  ...
  return (
    <div style={{ marginBottom: 20 }}>
      <MarketingTabBar active="reputation" onNavigate={onNavigate} alerts={alerts} insights={insights} onClearAlert={onClearAlert} />
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginTop: 16, gap: 16, flexWrap: 'wrap' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4, maxWidth: 576 }}>
          ...
          <p style={{ fontSize: 13, color: C.gray500 }}>
            Monitor external reviews, protect your reputation, and respond with the power of AI.
          </p>
        </div>
