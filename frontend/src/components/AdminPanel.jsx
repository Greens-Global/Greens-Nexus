...
const _LEGACY_MAP = [
  ...
  [/POST esign templates/,        'Created a Nexus Sign template'],
  [/PUT esign templates/,         'Updated a Nexus Sign template'],
  [/POST esign requests/,         'Sent a document for signature'],
  [/\w+ esign/,                   'Nexus Sign activity'],
