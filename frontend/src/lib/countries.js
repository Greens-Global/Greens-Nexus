// ISO 3166-1 country list with E.164 calling codes - shared by the Company
// Setup Overview form's Country field and its Main Phone country-code picker
// (Sep 18, Pranshu: "SHold have list of all countries in country dropdown").
// Sorted alphabetically by name; `code` is the ISO alpha-2, `dial` the "+N"
// calling code shown in the phone picker.
...
export const countryDial = (code) => COUNTRIES.find((c) => c.code === code)?.dial || '';
