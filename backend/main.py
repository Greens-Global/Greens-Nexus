...
def _run_migrations():
    ...
    if DATABASE_URL.startswith("sqlite"):
        ...
        sqlite_migrations = [
            ...
            # documents generated by the Send for Signature wizard are plumbing
            "ALTER TABLE documents ADD COLUMN source VARCHAR DEFAULT ''",
            "UPDATE documents SET source='esign-send' WHERE source='' "
            "AND template_id<>'' AND sign_request_id<>''",
    ...
    migrations = [
        ...
        "ALTER TABLE hr_sign_drafts ENABLE ROW LEVEL SECURITY",
